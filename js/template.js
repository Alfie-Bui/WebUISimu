...
const SIMULATOR_VERSION =
  "GemtekWeb_v10_26Jul24"; /* Release version and tag tracking */
    ...
    DeviceManagement: {
      ...
      TR369: {
        ...
        STOMP: {
          ...
          ControllerDest: "/queue/Controller1",
          AgentDest: "/queue/Agent1",
          STOMPServer: "stomp.server.hostname",
          STOMPPort: 61613,
          STOMPUser: "admin",
          STOMPPwd: "Admin@123",
          STOMPVirtual: "/",
          STOMPEnaEncryption: false,
          STOMPEnaHeartBeats: true,
        },
        MQTT: {
          Enable: false,
          ControllerEndpointID: "proto::Controller2",
          ControllerTopic: "/queue/Controller2",
          AgentTopic: "/queue/Agent1",
          MQTTServer: "mqtt.server.hostname",
          MQTTPort: 1883,
          MQTTUsername: "admin",
          MQTTPassword: "Admin@123",
          MQTTProtocolVersion: "3.1",
          MQTTTransportProtocol: "TCP/IP",
        },
      },
    },
    Multicast: {
